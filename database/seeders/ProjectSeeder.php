...
class ProjectSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $project1 = Project::create([
            ...
            'resource' => 'Tim surveyor BKI dan equipment inspeksi',
            'duration' => '3 minggu',
        ...
        $project2 = Project::create([
            ...
            'resource' => 'Tim surveyor senior, diving team, NDT specialists',
            'duration' => '4 bulan',
        ...
        $project3 = Project::create([
            ...
            'resource' => 'Naval architects, structural engineers, regulatory experts',
            'duration' => '2.5 bulan',
