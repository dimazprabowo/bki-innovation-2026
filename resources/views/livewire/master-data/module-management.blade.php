        ...
        <div class="flex items-center gap-2 w-full lg:w-auto">
            ...
            @can('modules_create')
                <a href="{{ route('master-data.modules.create') }}" wire:navigate x-data="{ loading: false }" @click="loading = true"
                   class="inline-flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 transition-colors flex-1 lg:flex-none">
