                ...
                <div class="relative bg-white dark:bg-gray-800 rounded-xl shadow-xl w-full max-w-md z-10 p-6 text-center">
                    ...
                    <div class="flex items-center justify-center gap-3">
                        <button @click="$wire.set('showDeleteModal', false)"
                            class="px-4 py-2.5 text-sm font-medium text-gray-600 dark:text-gray-300 hover:text-gray-800 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition">
                            Batal
                        </button>
