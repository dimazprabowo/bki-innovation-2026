                ...
                <div class="relative bg-white dark:bg-gray-800 rounded-xl shadow-xl w-full max-w-md z-10 overflow-hidden">
                    ...
                    <div class="flex items-center justify-center gap-3 px-6 pb-6">
                        ...
                        <button type="button"
                            ...
                            class="inline-flex items-center justify-center gap-2 px-5 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-semibold rounded-lg shadow-sm transition-all disabled:opacity-50 disabled:cursor-not-allowed">
