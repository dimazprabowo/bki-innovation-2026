...
<div class="mt-6">
    <div class="flex items-center justify-between mb-2">
        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">
            Kompetensi Personel
            <span class="ml-2 inline-flex items-center whitespace-nowrap px-2 py-0.5 text-xs font-semibold rounded-full @if(count($competencies) > 0) bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200 @else bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-300 @endif">
        ...
        <button type="button" wire:click="addCompetency" wire:key="add-competency-btn"
            ...
            @if(count($competencies) === 0)
                ...
                <span wire:loading.remove wire:target="addCompetency" class="hidden sm:inline">Tambah Kompetensi</span>
                <span wire:loading.remove wire:target="addCompetency" class="sm:hidden">Tambah</span>
