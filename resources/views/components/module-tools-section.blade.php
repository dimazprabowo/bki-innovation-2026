...
<div class="border-t border-gray-200 dark:border-gray-700 pt-6 mt-3">
    <div class="flex items-center justify-between mb-3">
        <div class="flex flex-col sm:flex-row sm:items-center">
            ...
            <span class="px-2 py-0.5 text-xs font-semibold rounded-full @if(count($tools) > 0) bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200 @else bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-300 @endif sm:ml-2 mt-1 sm:mt-0">
                {{ count($tools) }} alat
            </span>
        </div>
